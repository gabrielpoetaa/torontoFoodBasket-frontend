...
const data = [
  {
    id: 1,
    number: 3.232,
    content: "concurrencies of data",
  },
  {
    id: 2,
    number: "+67",
    content: "days of scraped data",
  },
];
// console.log(data);
...
function App() {
  ...
  const [receivedLowestPricePer100g, setreceivedLowestPricePer100g] = useState('-');
  const [receivedAveragePricePer100g, setReceivedAveragePricePer100g] = useState('-')
